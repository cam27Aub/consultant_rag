...
3. If the subgraph contains partial but relevant information, describe ONLY what the entities and relationships show. Then state which parts of the question could not be addressed, using only the user's own words — do NOT provide examples, elaborations, or hints drawn from your training data.
